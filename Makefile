...
srcdir = .
topdir = /Users/ndemonner/.rvm/rubies/ruby-2.1.2/include/ruby-2.1.0
hdrdir = $(topdir)
arch_hdrdir = /Users/ndemonner/.rvm/rubies/ruby-2.1.2/include/ruby-2.1.0/x86_64-darwin13.0
PATH_SEPARATOR = :
VPATH = $(srcdir):$(arch_hdrdir)/ruby:$(hdrdir)/ruby
prefix = $(DESTDIR)/Users/ndemonner/.rvm/rubies/ruby-2.1.2
...
sitearchdir = $(DESTDIR)./.gem.20140711-95360-deg1ce
sitelibdir = $(DESTDIR)./.gem.20140711-95360-deg1ce
...
CFLAGS   = $(CCDLFLAGS) -O3 -I/Users/travis/.sm/pkg/active/include -fPIC -mmacosx-version-min=10.7 -pipe $(ARCH_FLAG)
INCFLAGS = -I. -I$(arch_hdrdir) -I$(hdrdir)/ruby/backward -I$(hdrdir) -I$(srcdir)
DEFS     = 
CPPFLAGS = -DHAVE_LABS -DHAVE_LLABS -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags)
CXXFLAGS = $(CCDLFLAGS) $(cxxflags) $(ARCH_FLAG)
ldflags  = -L. -L/Users/travis/.sm/pkg/active/lib -fPIC -Bstatic -fstack-protector
...
$(RUBYLIBDIR)/bigdecimal/jacobian.rb: $(srcdir)/lib/bigdecimal/jacobian.rb $(TIMESTAMP_DIR)/.RUBYLIBDIR.-.bigdecimal.time
	$(Q) $(INSTALL_DATA) $(srcdir)/lib/bigdecimal/jacobian.rb $(@D)
...
$(RUBYLIBDIR)/bigdecimal/ludcmp.rb: $(srcdir)/lib/bigdecimal/ludcmp.rb $(TIMESTAMP_DIR)/.RUBYLIBDIR.-.bigdecimal.time
	$(Q) $(INSTALL_DATA) $(srcdir)/lib/bigdecimal/ludcmp.rb $(@D)
...
$(RUBYLIBDIR)/bigdecimal/math.rb: $(srcdir)/lib/bigdecimal/math.rb $(TIMESTAMP_DIR)/.RUBYLIBDIR.-.bigdecimal.time
	$(Q) $(INSTALL_DATA) $(srcdir)/lib/bigdecimal/math.rb $(@D)
...
$(RUBYLIBDIR)/bigdecimal/newton.rb: $(srcdir)/lib/bigdecimal/newton.rb $(TIMESTAMP_DIR)/.RUBYLIBDIR.-.bigdecimal.time
	$(Q) $(INSTALL_DATA) $(srcdir)/lib/bigdecimal/newton.rb $(@D)
...
$(RUBYLIBDIR)/bigdecimal/util.rb: $(srcdir)/lib/bigdecimal/util.rb $(TIMESTAMP_DIR)/.RUBYLIBDIR.-.bigdecimal.time
	$(Q) $(INSTALL_DATA) $(srcdir)/lib/bigdecimal/util.rb $(@D)
